...
package uk.gov.hmrc.platformstatusconsulfrontend.auth
...
class PlatformStatusAuthAction @Inject()(
  ...
  private val readPermission =
    Predicate.Permission(Resource(ResourceType("platform-status-consul-frontend"), ResourceLocation("*")), IAAction("READ"))
