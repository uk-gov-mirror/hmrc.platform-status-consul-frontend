...
package uk.gov.hmrc.platformstatusconsulfrontend.connectors
...
import uk.gov.hmrc.platformstatusconsulfrontend.models.GcInformation
import uk.gov.hmrc.platformstatusconsulfrontend.services.StatusChecker.PlatformStatus
...
class BackendConnector @Inject()(
  ...
  private val appMeshBackendBaseUrl: String =
